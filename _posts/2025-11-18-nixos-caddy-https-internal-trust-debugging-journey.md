...
index 23a7896..28c6037 100644
--- a/prompt.md
+++ b/prompt.md
@@ -897,34 +897,59 @@ After the rebuild is complete, run `trust-caddy` in your terminal. It will now c
 [mike@nixos:~/repos/nixos]$
 ```
...
-  /nix/store/zmg46qqi5xqcipnhf8c3yx0kiv287g2b-trust-caddy.drv
-  /nix/store/hib52lns8j6yvgcrpf76y05r58j93byq-system-path.drv
-  /nix/store/03lwhq1y3lbwc9dr4mimdf7mpjhsfxgk-etc-pam-environment.drv
-  /nix/store/971pnyghf79l3pkzhn59i4il1nz8sz3s-dbus-1.drv
-  /nix/store/mnrrd7dlx1dvngq07g5h3q0gjddyavzd-X-Restart-Triggers-polkit.drv
-  /nix/store/6fnsmcs93f0xgydqp67vdq5p95dimng8-unit-polkit.service.drv
-  /nix/store/i1cvrab8krqdwdi9ffmvbc6znc4apxf6-unit-accounts-daemon.service.drv
-  /nix/store/kgdssxm25ki45xx0azkhz64nk5dall65-X-Restart-Triggers-dbus.drv
-  /nix/store/sb73bvrzp01hdfp5nnahsxkgyhl98cz6-unit-dbus.service.drv
-  /nix/store/c6lz0nvx3ddjfxrg61bbbla7kf93xkgc-system-units.drv
-  /nix/store/pwxf5y0wzag26gzynypnabzvfa8cynrd-set-environment.drv
-  /nix/store/ps4hn38p81wc85a7diqmjld1fsz4si9p-etc-profile.drv
-  /nix/store/bvvy2qm2q66ysb33hfgnafaqvl0bhgmm-unit-dbus.service.drv
-  /nix/store/z24cik3ri61ngiizj2hfk0slz88j3v60-user-units.drv
-  /nix/store/cy4v6wasx8dij04avrcaj7530i8iv8h5-etc.drv
-  /nix/store/0gm6kq875kfxyfkkagz8l568yvihd0xi-nixos-system-nixos-25.05.812880.4c8cdd5b1a63.drv
-building '/nix/store/zmg46qqi5xqcipnhf8c3yx0kiv287g2b-trust-caddy.drv'...
-/nix/store/lz4pcc2llybnig3a0mi2wkvgf9xmgihq-trust-caddy/bin/trust-caddy: line 30: syntax error: unexpected end of file
-error: builder for '/nix/store/zmg46qqi5xqcipnhf8c3yx0kiv287g2b-trust-caddy.drv' failed with exit code 2
-error: 1 dependencies of derivation '/nix/store/hib52lns8j6yvgcrpf76y05r58j93byq-system-path.drv' failed to build
-error: 1 dependencies of derivation '/nix/store/0gm6kq875kfxyfkkagz8l568yvihd0xi-nixos-system-nixos-25.05.812880.4c8cdd5b1a63.drv' failed to build
+[mike@nixos:~/repos/nixos]$ trust-caddy
+🔐 NIXOS CADDY TRUST INSTALLER 🔐
+📋 Found Root CA. Copying to local directory...
+🛡️  Installing to NSS Databases (Firefox/Chrome)...
