...
categories: vim, linux, python, git, human, muscle memory, journaling
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="righteous-feedback-loops-of-self-improvement">Righteous Feedback Loops of Self-Improvement</a></div><div class="post-nav-next"><a href="enabling-vim-s-visual-block-mode-on-linux-wsl-ctrl-v">Enabling vim's Visual Block mode on Linux WSL (Ctrl+v)</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
