...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="what-do-you-do-when-you-approach-a-new-api">What do you do when you approach a new API?</a></div><div class="post-nav-next"><a href="clarified-linux-python-vim-git-mission-on-homepage">Clarified Linux, Python, vim & git Mission on Homepage</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
