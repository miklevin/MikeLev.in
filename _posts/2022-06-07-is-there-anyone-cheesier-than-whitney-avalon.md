...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="i-ll-blow-up-on-youtube-when-i-want-to">I'll Blow Up On YouTube When I Want To</a></div><div class="post-nav-next"><a href="learning-linux-lesson-2-run-run-it-from-cli">Learning Linux Lesson #2: RUN! Run it from CLI!</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
