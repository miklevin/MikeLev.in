...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="thinking-through-jupyter-video">Thinking Through Jupyter Video</a></div><div class="post-nav-next"><a href="from-zero-windows-to-linux-in-8-steps">From Zero (Windows) to Linux In 8 Steps</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
