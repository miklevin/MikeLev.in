...
categories: vim, command-line, linux, vscode, git, ubuntu, youtube, unix, ai
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="automating-2fa-web-login-via-microsoft-playwright">Automating 2FA Web Login via Microsoft Playwright</a></div><div class="post-nav-next"><a href="api-choices-rational-folks-won-t-say-magic">API Choices & Rational Folks Won't Say Magic</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
