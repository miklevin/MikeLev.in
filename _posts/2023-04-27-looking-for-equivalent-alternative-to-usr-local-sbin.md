...
categories: vim, .vimrc, macro, terminal, neovim
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="adding-an-advice-from-openai-field-to-my-journal">Adding an Advice From OpenAI Field to my Journal</a></div><div class="post-nav-next"><a href="neovim-publishing-macro-using-terminal-expand">NeoVim Publishing Macro Using :terminal & expand()</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
