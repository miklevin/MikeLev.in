...
categories: jekyll, python, loop, github pages, google analytics, blogging
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="templatizing-google-analytics-measurement-id-in-jekyll-github-pages">Templatizing Google Analytics MEASUREMENT ID in Jekyll Github Pages</a></div><div class="post-nav-next"><a href="bash-script-loading-external-files">Bash Script Loading External Files</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
