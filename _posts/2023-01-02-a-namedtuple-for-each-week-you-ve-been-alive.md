...
categories: coding, vim, productivity, linux, wisdom, microsoft, journaling, python, javascript, jupyterlab, text editor
...
It's not bad. It's just new, and we will adapt. Things aren't so bad so long as
...
Can't there be ancient and usable? Isn't there anything in tech that transmits
...
Vim for you, I assure you it's true. You won't think so at first, then you'll
...
The good news is that we're in a golden age. Microsoft lets you run Linux for
...
<div class="arrow-links"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/life-in-weeks-ipynb/">life_in_weeks.ipynb</a></div> &nbsp; <div class="post-nav-next"><a href="/blog/every-week-date-for-last-30-years-with-fixed-ids/">Every Week Date for Last 30 Years With Fixed IDs</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
