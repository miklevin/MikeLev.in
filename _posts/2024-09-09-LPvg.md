---
title: Linux, Python, Vim & Git (LPvg) A Minimum Tech Toolkit for Life
permalink: /LPvg/
description: Master Linux, Python, Vim, and Git (LPvg) as your minimum tech toolkit to stay relevant, resist obsolescence, and embrace open-source freedom with Nix, Jupyter Notebooks, and Pythonic web development using FastHTML and HTMX.
layout: post
---
...
Feel free to let me know if there's anything else you'd like me to add or adjust!
