...
categories: api, git, powershell, jupyter notebook, csv, python, virtualenv, pandas, bash, 80/20-rule
...
<div class="arrow-links"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/throw-all-the-meat-veggies-into-the-stew-stir-the-blog-vlog/">Throw All The Meat & Veggies Into The Stew & Stir The Blog / Vlog</a></div> &nbsp; <div class="post-nav-next"><a href="/blog/there-s-no-place-like-home-you-get-to-decide-where-that-is-or-do-you/">There's No Place Like Home & You Get To Decide Where That Is... Or Do You?</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
