...
categories: python, bash, jekyll, git, vim
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&nbsp;&rarr;</span><a href="/blog/path-f-path-mkdir-parents-true-exist-ok-true/">Path(f'{\_path}').mkdir(parents=True, exist_ok=True)</a></div> &nbsp; <div class="post-nav-next"><a href="/blog/vim-b1-commands-much-force-like-obi-wan/">vim :b1 Commands Much Force Like Obi-Wan</a><span class="arrow">&larr;&nbsp;</span></div></div>
## Categories
