...
categories: vim, jekyll, python, git, bash
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="path-f-path-mkdir-parents-true-exist-ok-true">Path(f'{\_path}').mkdir(parents=True, exist_ok=True)</a></div><div class="post-nav-next"><a href="vim-b1-commands-much-force-like-obi-wan">vim :b1 Commands Much Force Like Obi-Wan</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
