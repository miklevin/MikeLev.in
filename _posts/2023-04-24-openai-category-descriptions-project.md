...
<div class="post-nav"><div class="post-nav-next"><a href="/blog/defaultdict-s-returning-keys-with-lambdas-needs-default-none">DefaultDict's Returning Keys with Lambdas Needs Default None</a><span class="arrow">&nbsp;&rarr;</span></div> &nbsp; <div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/gathering-all-category-logic-into-one-place">Gathering All Category Logic into One Place</a></div></div>
## Categories
