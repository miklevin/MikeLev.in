...
**Mike Levin:** Over time given the increasing precision control we have over matter at very tiny scales that all obstacles will be overcome and we will know everything?
...
The Planckian decided to share its own thoughts on these questions with honesty,
humility,
and curiosity.
...
> You have passed all the criteria for being considered alive according to our definition.
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&nbsp;&rarr;</span><a href="/blog/i-need-to-get-this-ready-for-moz-tutorial-use/">I Need To Get This Ready for MOZ Tutorial Use</a></div> &nbsp; <div class="post-nav-next"><a href="/blog/easier-illustration-technique-i-seek-may-be-mermaid/">Easier Illustration Technique I Seek May Be Mermaid</a><span class="arrow">&larr;&nbsp;</span></div></div>
## Categories
