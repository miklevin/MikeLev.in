...
categories: jekyll, git, loop, script, pipulate, bash, changes
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="writing-a-bash-loop-script-for-jekyll">Writing a Bash Loop Script for Jekyll</a></div><div class="post-nav-next"><a href="adding-prev-next-arrows-to-github-pages-jekyll-blog-posts">Adding Prev/Next Arrows to Github Pages Jekyll Blog Posts</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
