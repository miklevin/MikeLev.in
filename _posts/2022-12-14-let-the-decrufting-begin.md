...
categories: vim, linux, python, git, changes
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="me-vs-chatgpt-tell-me-why-i-should-use-the-python-programming-language">Me vs. ChatGPT: Tell me why I should use the Python programming language.</a></div><div class="post-nav-next"><a href="using-named-tuples-to-define-api-job-perform-housekeeping">Using Named Tuples to Define API-job & Perform Housekeeping</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
