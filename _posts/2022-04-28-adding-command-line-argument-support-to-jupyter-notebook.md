...
categories: vim, jupyter notebook, jekyll, python, git
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="adding-command-line-argument-support-to-jupyter-notebook">Adding Command-Line Argument Support to Jupyter Notebook</a></div><div class="post-nav-next"><a href="every-little-project-gets-done-elpgd">Every Little Project Gets Done (ELPGD)</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
