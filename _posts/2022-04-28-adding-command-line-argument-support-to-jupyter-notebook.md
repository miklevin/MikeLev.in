...
categories: blogslicer, python, jupyter notebook, jekyll, git, vim
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&nbsp;&rarr;</span><a href="/blog/adding-command-line-argument-support-to-jupyter-notebook/">Adding Command-Line Argument Support to Jupyter Notebook</a></div> &nbsp; <div class="post-nav-next"><a href="/blog/every-little-project-gets-done-elpgd/">Every Little Project Gets Done (ELPGD)</a><span class="arrow">&larr;&nbsp;</span></div></div>
## Categories
