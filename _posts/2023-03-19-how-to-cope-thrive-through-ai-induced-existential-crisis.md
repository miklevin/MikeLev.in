...
categories: vim, imposter syndrome, linux, vscode, coding, python, git, journaling, ai
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="clarified-linux-python-vim-git-mission-on-homepage">Clarified Linux, Python, vim & git Mission on Homepage</a></div><div class="post-nav-next"><a href="addictive-self-reinforcing-double-helix-pair-of-motivating-projects">Addictive & Self-Reinforcing Double-Helix Pair of Motivating Projects</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
