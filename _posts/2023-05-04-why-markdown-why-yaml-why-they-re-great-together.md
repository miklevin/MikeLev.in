...
categories: vendors, gnu, yaml, javascript, python, web development, unix, json, github
...
<div class="arrow-links"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/added-support-for-arbitrary-jekyll-yaml-fields/">Added Support for Arbitrary Jekyll YAML Fields</a></div> &nbsp; <div class="post-nav-next"><a href="/blog/an-ode-to-the-status-quo/">An Ode to The Status Quo</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
