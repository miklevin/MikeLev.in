...
categories: python, web development, javascript, yaml, github, gnu, unix
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="added-support-for-arbitrary-jekyll-yaml-fields">Added Support for Arbitrary Jekyll YAML Fields</a></div><div class="post-nav-next"><a href="an-ode-to-the-status-quo">An Ode to The Status Quo</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
