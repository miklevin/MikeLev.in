...
categories: jupyter notebook, coding, journaling, yaml
...
<div class="post-nav"><div class="post-nav-next"><a href="/blog/admiring-the-usefulness-of-yaml-ness-in-my-journaling-system">Admiring the Usefulness of YAML-ness in my Journaling System</a><span class="arrow">&nbsp;&rarr;</span></div> &nbsp; <div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/defaultdict-s-returning-keys-with-lambdas-needs-default-none">DefaultDict's Returning Keys with Lambdas Needs Default None</a></div></div>
## Categories
