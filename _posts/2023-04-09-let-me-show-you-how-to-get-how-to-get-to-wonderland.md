...
categories: vim, linux, python, git, jupyterlab, web development, journaling
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="blog-slice-dice-system-re-written-in-a-day">Blog Slice & Dice System Re-Written In a Day</a></div><div class="post-nav-next"><a href="refining-my-vimrc-now-that-it-s-a-neovim-init-vim">Refining my .vimrc now that it's a NeoVim init.vim</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
