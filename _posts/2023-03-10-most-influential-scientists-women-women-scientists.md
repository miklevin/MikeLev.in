...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="desperately-seeking-a-better-intro-to-math-science-a-pythonic-one">Desperately Seeking a Better Intro to Math & Science. A Pythonic One?</a></div><div class="post-nav-next"><a href="even-if-ai-can-t-solve-unsolvable-problems-it-sure-can-write-stories-about-them">Even if AI Can't Solve Unsolvable Problems, It Sure Can Write Stories About Them!</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
