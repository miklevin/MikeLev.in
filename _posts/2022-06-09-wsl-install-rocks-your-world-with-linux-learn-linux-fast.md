...
categories: text editor, script, vscode, wsl, skills, platforms, windows 11, python, unix, linux, terminal, git, vim
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&nbsp;&rarr;</span><a href="/blog/remain-positive-know-signs-of-when-you-re-doing-something-right/">Remain Positive & Know Signs Of When You're Doing Something Right</a></div> &nbsp; <div class="post-nav-next"><a href="/blog/installing-wsl2-on-windows-10-requires-kernel-update-and-hypervisor-turned-on/">Installing WSL2 on Windows 10 Requires Kernel Update And Hypervisor Turned On</a><span class="arrow">&larr;&nbsp;</span></div></div>
## Categories
