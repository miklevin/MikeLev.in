...
categories: vim, linux, vscode, wsl, python, git, skills, text editor, script, windows 11, terminal, platforms, unix
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="remain-positive-know-signs-of-when-you-re-doing-something-right">Remain Positive & Know Signs Of When You're Doing Something Right</a></div><div class="post-nav-next"><a href="installing-wsl2-on-windows-10-requires-kernel-update-and-hypervisor-turned-on">Installing WSL2 on Windows 10 Requires Kernel Update And Hypervisor Turned On</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
