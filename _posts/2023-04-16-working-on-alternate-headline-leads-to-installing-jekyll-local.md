...
categories: journal.md, openai, jekyll, templates, ai, seo, moz, github
...
If I could use AI in the future, the first thing that I'd like to do, is to
...
I'm trying now with very little top matter and no headlines, bylines and dates.
...
<div class="post-nav"><div class="post-nav-next"><a href="/blog/openai-vs-kmeans-for-keyword-clustering">OpenAI Vs. KMeans for Keyword Clustering</a><span class="arrow">&nbsp;&rarr;</span></div> &nbsp; <div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/learnings-from-weekend-openai-keyword-extraction-clustering-project">Learnings From Weekend OpenAI Keyword Extraction & Clustering Project</a></div></div>
## Categories
