...
categories: vscode, api, error, openai, neovim, copilot
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="challenging-openai-to-write-a-better-subhead-than-this-headline">Challenging OpenAI to Write a Better Subhead Than this Headline</a></div><div class="post-nav-next"><a href="working-on-alternate-headline-leads-to-installing-jekyll-local">Working on Alternate Headline Leads to Installing Jekyll Local</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
