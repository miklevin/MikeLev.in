...
categories: python, google photos, automation, scripts, tutorial, microsoft playwright
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="backup-google-photos-to-self-hosted-alternative">Backup Google Photos to Self Hosted Alternative</a></div><div class="post-nav-next"><a href="nbdev-makes-py-file-extractions-from-notebooks">nbdev Makes .py-file Extractions From Notebooks</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
