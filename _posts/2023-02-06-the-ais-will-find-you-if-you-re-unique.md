...
categories: google photos, scripts, microsoft playwright, python, automation, tutorial
...
<div class="post-nav"><div class="post-nav-next"><a href="/blog/nbdev-makes-py-file-extractions-from-notebooks">nbdev Makes .py-file Extractions From Notebooks</a><span class="arrow">&nbsp;&rarr;</span></div> &nbsp; <div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/backup-google-photos-to-self-hosted-alternative">Backup Google Photos to Self Hosted Alternative</a></div></div>
## Categories
