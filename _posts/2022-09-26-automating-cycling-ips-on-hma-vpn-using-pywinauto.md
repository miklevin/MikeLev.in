...
categories: script, journey, automation, python
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="serp-scraping-with-site-search-modifier-and-custom-date-range">SERP Scraping with site Search Modifier and Custom Date Range</a></div><div class="post-nav-next"><a href="programming-a-python-do-nothing-machine">Programming a Python Do Nothing Machine</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
