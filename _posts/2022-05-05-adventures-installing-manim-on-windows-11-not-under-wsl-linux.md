...
categories: linux, python, mac, powershell, windows 10, windows 11, virtualenv
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="adventures-installing-manim-on-windows-11-not-under-wsl-linux">Adventures Installing Manim on Windows 11 (Not Under WSL Linux)</a></div><div class="post-nav-next"><a href="path-f-path-mkdir-parents-true-exist-ok-true">Path(f'{\_path}').mkdir(parents=True, exist_ok=True)</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
