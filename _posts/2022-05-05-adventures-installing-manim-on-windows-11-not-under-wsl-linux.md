...
categories: linux, python, windows 10, mac, virtualenv, windows 11, powershell
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/adventures-installing-manim-on-windows-11-not-under-wsl-linux">Adventures Installing Manim on Windows 11 (Not Under WSL Linux)</a></div> &nbsp; <div class="post-nav-next"><a href="/blog/path-f-path-mkdir-parents-true-exist-ok-true">Path(f'{\_path}').mkdir(parents=True, exist_ok=True)</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
