...
categories: linux, windows 11, python, virtualenv, mac, windows 10, powershell
...
<div class="post-nav"><div class="post-nav-next"><a href="/blog/path-f-path-mkdir-parents-true-exist-ok-true">Path(f'{\_path}').mkdir(parents=True, exist_ok=True)</a><span class="arrow">&nbsp;&rarr;</span></div> &nbsp; <div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/adventures-installing-manim-on-windows-11-not-under-wsl-linux">Adventures Installing Manim on Windows 11 (Not Under WSL Linux)</a></div></div>
## Categories
