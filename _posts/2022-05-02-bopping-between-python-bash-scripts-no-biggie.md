...
categories: journal.md, scripts, bash, python, github
...
<div class="post-nav"><div class="post-nav-next"><a href="/blog/activating-all-my-registered-domains">Activating All My Registered Domains</a><span class="arrow">&nbsp;&rarr;</span></div> &nbsp; <div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/bopping-between-python-bash-scripts-no-biggie">Bopping Between Python & Bash Scripts No Biggie</a></div></div>
## Categories
