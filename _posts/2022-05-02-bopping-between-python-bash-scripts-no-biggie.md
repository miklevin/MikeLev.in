...
categories: python, scripts, journal.md, github, bash
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="bopping-between-python-bash-scripts-no-biggie">Bopping Between Python & Bash Scripts No Biggie</a></div><div class="post-nav-next"><a href="activating-all-my-registered-domains">Activating All My Registered Domains</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
