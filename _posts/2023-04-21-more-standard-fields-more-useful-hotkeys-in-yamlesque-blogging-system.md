...
categories: keywords, vim, meta descriptions, macro, neovim
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="yaml-validation-now-baked-into-yamlesque-journaling-system">YAML-validation Now Baked Into YAMLesque Journaling System</a></div><div class="post-nav-next"><a href="starting-a-new-blogging-system-create-a-title-field-under-date-to-release">Starting a New Blogging System (create a title field under date to release)</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
