...
categories: linux, cat, wsl, powershell, neovim, journaling
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="levinux-pipulate-yamlesque">Levinux, Pipulate & YAMLesque</a></div><div class="post-nav-next"><a href="python-virtual-env-better-than-usr-local-sbin">Python Virtual Env Better Than /usr/local/sbin</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
