...
categories: science, journaling, yaml, javascript, nodejs, jekyll, math, github pages, web development
...
<div class="post-nav"><div class="post-nav-next"><a href="/blog/embrace-displace-embrace-a-new-place-wsl2-linux">Embrace & Displace --> Embrace a New Place (WSL2 Linux)</a><span class="arrow">&nbsp;&rarr;</span></div> &nbsp; <div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/git-rebase-i-root-vs-git-init-anew">`git rebase -i --root` vs. `git init` anew</a></div></div>
## Categories
