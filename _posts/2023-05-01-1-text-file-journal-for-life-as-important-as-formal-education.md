...
categories: javascript, web development, jekyll, science, journaling, github pages, hardware, yaml, nodejs, math
...
<div class="post-nav"><div class="post-nav-prev"><span class="arrow">&larr;&nbsp;</span><a href="/blog/git-rebase-i-root-vs-git-init-anew">`git rebase -i --root` vs. `git init` anew</a></div><div class="post-nav-next"><a href="/blog/embrace-displace-embrace-a-new-place-wsl2-linux">Embrace & Displace --> Embrace a New Place (WSL2 Linux)</a><span class="arrow">&nbsp;&rarr;</span></div></div>
## Categories
